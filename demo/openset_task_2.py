...
def task_openset(model, ref_images, image_tgt=None, text_size=640,hole_scale=100,island_scale=100):
    in_context_examples = [x for x in ref_images if x is not None]
    t = []
